...
## scraping MID : Заявления, выступления, статьи и интервью заместителей Министра иностранных дел Российской Федерации
...
link = 'http://mid.ru/bdomp/brp_4.nsf/spsvyz!OpenView&Start=1' #стартовая позиция        
